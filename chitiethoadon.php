...
if ($result->num_rows > 0) {
    ...
    echo '<tr>';
    echo '   <td></td>';
    echo '   <td><a href="info.php"><i class="fa-solid fa-right-from-bracket btn_huy"></i></a></td>';
    echo '</tr>';
    }
  }else {
    echo'    <tr>';
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($total_result->num_rows > 0) {
                    ...
                    echo '    <tr>';
                    echo '    <td class="image"><a href="chitietsanpham.php?pro_id='.$product_info['pro_id'].'"><img src="admin/' . $product_info['pro_image'] . '" alt=""></a></td>';
